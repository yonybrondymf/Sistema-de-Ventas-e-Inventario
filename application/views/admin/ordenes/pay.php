                            ...
                            <table class="table table-hover table-bordered" id="tborden">
                                ...
                                <tbody>
                                    <?php foreach ($productos as $producto): ?>
                                        <tr>
                                            <?php
                                                $data = $producto->idprod."*".$producto->nombre."*".$producto->precio."*".$producto->cantidad."*".$producto->id;
                                            ?>
                                            <?php 
                                                $opciones ="";
                    ...
                    <div class="tab-content">
                      ...
                      <div class="tab-pane" id="tab_2">
                        <form action="<?php echo base_url();?>movimientos/ventas/savecliente" method="POST" id="form-cliente">
                            ...
                            <div class="form-group">
                                <label for="numerodoc">No. de Documento:</label>
                                <input type="text" class="form-control" id="numerodoc" name="numero" required>
                            </div>
